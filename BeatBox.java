...
public class BeatBox {
    ...
    public void buildGUI() {
        ...
        //Создаем кнопки и привязываем к ним соответствующие actionListener's
        ...
        //Создаем лейблы с названиями инструментов построчно
        Box nameBox = new Box(BoxLayout.Y_AXIS);
        for (int i = 0; i < 16; i++) {

            nameBox.add(new Label(instrumentNames[i]));
            nameBox.add(Box.createRigidArea(new Dimension(0, 5)));
        }
